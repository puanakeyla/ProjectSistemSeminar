              ...
              {seminars.map((seminar) => (
                ...
                >
                  ...
                  <div className="seminar-item-info">
                    <span>👤 {seminar.mahasiswa_name}</span>
                    <span>🆔 {seminar.mahasiswa_npm}</span>
                  </div>
                  <div className="seminar-item-footer">
                    <span className="date">📅 {formatDate(seminar.created_at)}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <>
                  ...
                  <div className="info-item">
                    ...
                    <p>
                      <span className={`type-badge ${seminarDetail.tipe}`}>
                        {seminarDetail.tipe === 'proposal' ? '📋 Proposal' : '📘 Hasil'}
                      </span>
                    </p>
                  </div>
                  <div className="info-item">
              ...
              {seminarDetail.approvals?.filter(a => a.status === 'approved').length < 3 && (
                <div className="warning-message">
                  ⚠️ Seminar hanya dapat diverifikasi jika semua dosen (Pembimbing 1, Pembimbing 2, dan Penguji) telah menyetujui
                </div>
              )}
            </>
          ) : (
